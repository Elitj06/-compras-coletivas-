...
CREATE INDEX IF NOT EXISTS idx_pin_recovery_challenges_expires_at ON pin_recovery_challenges(expires_at);
...
CREATE INDEX IF NOT EXISTS idx_pin_recovery_rate_limits_expires_at ON pin_recovery_rate_limits(expires_at);
...
CREATE INDEX IF NOT EXISTS idx_pin_recovery_audit_created_at ON pin_recovery_audit(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_pin_recovery_audit_buyer ON pin_recovery_audit(comprador_id, created_at DESC);
